    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir rechnen mit leichten Turbulenzen. Bitte kehren Sie zu Ihren Plätzen zurück und schnallen Sie sich an."
      },
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir haben gerade Informationen über leichte Turbulenzen erhalten. Bitte kehren Sie zu Ihren Plätzen zurück und bleiben Sie sitzen, bis das Anschnallzeichen erlischt."
      },
      {
        ...
        "ge": "Hallo Leute, hier spricht Ihr Kapitän. Aufgrund leichter Turbulenzen vor uns wurde das Anschnallzeichen aktiviert. Bitte kehren Sie zu Ihren Plätzen zurück und schnallen Sie sich an."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Meine Damen und Herren, unser Kapitän hat uns gerade mitgeteilt, dass wir mit leichten Turbulenzen rechnen. Bitte kehren Sie zu Ihren Plätzen zurück und bleiben Sie sitzen, bis das Anschnallzeichen erlischt. Die Nutzung der Toiletten ist derzeit nicht gestattet."
      },
      {
        ...
        "ge": "Unser Kapitän hat uns gerade mitgeteilt, dass wir mit leichten Turbulenzen rechnen. Bitte legen Sie den Gurt an."
      },
      {
        ...
        "ge": "Wie Sie von unserem Kapitän erfahren haben, rechnen wir mit leichten Turbulenzen. Bitte kehren Sie zu Ihren Plätzen zurück und schnallen Sie sich an. Die Nutzung der Toiletten ist derzeit nicht gestattet."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Meine Damen und Herren, der Kapitän hat das Anschnallzeichen eingeschaltet. Bitte kehren Sie zu Ihren Plätzen zurück und schnallen Sie sich an."
      },
      {
        ...
        "ge": "Meine Damen und Herren, das Anschnallzeichen ist eingeschaltet. Bitte kehren Sie zu Ihren Plätzen zurück und schnallen Sie sich an. Die Nutzung der Toiletten ist derzeit nicht gestattet."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Meine Damen und Herren, der Kapitän hat das Anschnallzeichen ausgeschaltet. Sie können sich jetzt in der Kabine bewegen, wir empfehlen Ihnen jedoch, im Sitzen den Sicherheitsgurt angelegt zu lassen, um unerwartete Turbulenzen zu vermeiden."
      },
      {
        ...
        "ge": "Wie Sie sehen, wurden die Anschnallzeichen ausgeschaltet. Sie können sich jetzt in der Kabine bewegen, wir empfehlen Ihnen jedoch, im Sitzen den Sicherheitsgurt angelegt zu lassen, um unerwartete Turbulenzen zu vermeiden."
      },
      {
        ...
        "ge": "Die Anschnallzeichen wurden gerade ausgeschaltet. Sie können sich nun in der Kabine bewegen. Für den Fall unerwarteter Turbulenzen empfehlen wir Ihnen, im Sitzen den Sicherheitsgurt angelegt zu lassen."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir erleben derzeit eine Verzögerung. Wir entschuldigen uns für die Unannehmlichkeiten und werden Sie über den weiteren Verlauf auf dem Laufenden halten. Wir arbeiten hart daran, Sie so schnell wie möglich auf den Weg zu bringen. Vielen Dank für Ihre Geduld."
      },
      {
        ...
        "ge": "Hallo, hier spricht Ihr Kapitän. Leider kommt es derzeit zu einer Verzögerung. Wir entschuldigen uns für die Unannehmlichkeiten und werden Sie über den weiteren Verlauf auf dem Laufenden halten. Vielen Dank für Ihre Geduld und Ihr Verständnis."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Für die Verzögerung möchten wir uns noch einmal bei Ihnen entschuldigen. Wir hoffen, dass Sie einen angenehmen Flug hatten und freuen uns auf ein baldiges Wiedersehen."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Willkommen an Bord dieses {airlineName}-Fluges von {originCityName} nach {destinationCityName}. Mein Name ist {captainName} und ich bin der Kapitän dieses Fluges. Ich begrüße Sie an Bord und danke Ihnen, dass Sie sich entschieden haben, heute mit uns zu fliegen. Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Unser heutiger Flug wird ungefähr {flightTime} dauern. Wenn Sie Fragen haben oder Hilfe benötigen, wenden Sie sich bitte an einen unserer Flugbegleiter. Vielen Dank, dass Sie mit {airlineName} geflogen sind."
      },
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, willkommen an Bord des {airlineName}-Fluges von {originCityName} nach {destinationCityName}. Mein Name ist {captainName} und ich bin der Kapitän dieses Fluges. Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Vielen Dank, dass Sie sich für {airlineName} entschieden haben. Guten Flug."
      },
      {
        ...
        "ge": "Hallo Leute, hier spricht Ihr Kapitän. Willkommen an Bord dieses {airlineName}-Fluges von {originCityName} nach {destinationCityName}. Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Vielen Dank, dass Sie sich entschieden haben, heute mit uns zu fliegen."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Willkommen an Bord dieses {airlineName}-Fluges. Heute fliegen wir von {originCityName} nach {destinationCityName}. Mein Name ist {crewName} und ich bin ihr Flugbegleiter auf diesem Flug. Wir bereiten uns derzeit auf den Abflug vor und werden in Kürze abheben. Bitte stellen Sie sicher, dass Ihr Sicherheitsgurt angelegt ist und sich Ihre Rückenlehne und Ihr Tabletttisch in einer aufrechten Position befinden. Wenn Sie Fragen haben oder Hilfe benötigen, zögern Sie bitte nicht, mich oder einen meiner Kollegen zu fragen. Vielen Dank, dass Sie mit {airlineName} geflogen sind."
      },
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, willkommen an Bord des {airlineName}-Fluges von {originCityName} nach {destinationCityName}. Mein Name ist {crewName} und ich bin ihr Flugbegleiter auf diesem Flug. Wir bitten Sie, zu diesem Zeitpunkt Ihre Sicherheitsgurte anzulegen und das gesamte Gepäck unter Ihrem Sitz oder in den Gepäckfächern zu verstauen. Wir bitten Sie außerdem, Ihre Sitze und Tischablagen zum Abflug in eine aufrechte Position zu bringen. Bitte schalten Sie alle persönlichen elektronischen Geräte, einschließlich Laptops und Mobiltelefone, aus. Für die Dauer des Fluges ist das Rauchen verboten. Vielen Dank, dass Sie sich für {airlineName} entschieden haben. Guten Flug."
      }
    ]
  },
  ...
  // Basic information about the flight
  {
    ...
    "texts": [
      ...
      },
      {
        ...
        "ge": "Hallo, ich bin es wieder. Ich dachte, ich teile einige Informationen mit Ihnen. Unser heutiger Flug wird ungefähr {flightTime} dauern. Das Wetter in {destinationCityName} ist {destinationCityWeatherHumanDescription}. Wir erwarten einen ruhigen Flug mit einer geringen Wahrscheinlichkeit leichter Turbulenzen. Bitte entspannen Sie sich und genießen Sie den Flug."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, kurz nach dem Start servieren wir Ihnen Snacks und Getränke. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen."
      },
      {
        ...
        "ge": "Kurz nach dem Start beginnen wir mit dem Servieren von Snacks und Getränken. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Unser heutiger Flug wird ungefähr {flightTime} dauern. Der Kapitän hat mir mitgeteilt, dass der Flug reibungslos verlaufen sollte. Kurz nach dem Start beginnen wir mit dem Servieren von Snacks und Getränken. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, bitte bleiben Sie sitzen, während wir auf unsere Reiseflughöhe steigen. Wir werden in Kürze mit unserem Bordservice beginnen. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen."
      },
      {
        ...
        "ge": "Wir steigen jetzt auf unsere Reiseflughöhe. Wir werden in Kürze mit unserem Bordservice beginnen. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Meine Damen und Herren, wir starten jetzt unseren Bordservice. Wir möchten Sie daran erinnern, dass wir sowohl Kartenzahlungen als auch Bargeld akzeptieren. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen. Bitte bleiben Sie sitzen, während wir Sie bedienen. Wenn Sie etwas benötigen, zögern Sie bitte nicht, eines unserer Kabinenpersonalmitglieder zu fragen. Vielen Dank."
      },
      {
        ...
        "ge": "Wir starten jetzt unseren Bordservice. Wir möchten Sie daran erinnern, dass wir sowohl Kartenzahlungen als auch Bargeld akzeptieren. Unser Sky-Menü finden Sie in der Sitztasche vor Ihnen. Bitte bleiben Sie sitzen, während wir Sie bedienen. Wenn Sie etwas benötigen, zögern Sie bitte nicht, eines unserer Kabinenpersonalmitglieder zu fragen. Danke schön."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Sehr Damen und Herren, wir starten jetzt unseren Bordeinkaufsservice. Heute haben wir ein besonderes Angebot für Sie. Unsere Rubbellose sind jetzt zum Kauf verfügbar. Zu gewinnen gibt es einen Freiflug oder andere tolle Preise. Viel Glück!"
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "MSehr geehrte Damen und Herren, wir starten jetzt unseren Bordeinkaufsservice. Heute haben wir ein besonderes Angebot für Sie. Wenn Sie zwei Parfums kaufen, erhalten Sie 10 % Rabatt auf das dritte."
      },
      {
        ...
        "ge": "Wir starten jetzt unseren Bordeinkaufsservice. Heute empfehlen wir Ihnen unser Sonderangebot – ein Set mit drei Parfums zum Preis von zwei. Sie finden unseren Einkaufskatalog in der Sitztasche vor Ihnen."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, hier spricht Ihr Kapitän. Wir fliegen derzeit in einer Höhe von {currentAltitudeFt} Fuß mit einer Geschwindigkeit von {groundSpeedKm} Kilometern pro Stunde. Das Wetter in {destinationCityName} ist {destinationCityWeatherHumanDescription} mit einer Temperatur von {destinationCityTemperature} Grad. Lehnen Sie sich zurück, entspannen Sie sich und genießen Sie den Rest des Fluges."
      },
      {
        ...
        "ge": "Hallo, ich bin es wieder. Ich möchte ein paar Informationen mit Ihnen teilen. Wir fliegen derzeit in einer Höhe von {currentAltitudeFt} Fuß mit einer Geschwindigkeit von {groundSpeedKm} Kilometern pro Stunde. Das Wetter in {destinationCityName} ist {destinationCityWeatherHumanDescription} mit einer Temperatur von {destinationCityTemperature} Grad. Genieße den Flug."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir beginnen unseren Sinkflug nach {destinationCityName}. Bitte folgen Sie den Anweisungen des Kabinenpersonals, während wir uns auf die Landung vorbereiten. Danke schön."
      },
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir beginnen unseren Sinkflug. Bitte folgen Sie den Anweisungen des Kabinenpersonals, während wir uns auf die Landung vorbereiten. Danke schön."
      }
    ]
  },
  {
    ...
    "texts": [
      {
        ...
        "ge": "Seh Dr geehrte Damen und Herren, wie Sie von unserem Kapitän gehört haben, beginnen wir unseren Sinkflug nach {destinationCityName}. Bitte stellen Sie sicher, dass Ihr Sicherheitsgurt angelegt ist und sich Ihre Rückenlehne und Ihr Tabletttisch in einer aufrechten Position befinden. Wir holen alle verbleibenden Serviceartikel in wenigen Minuten ab. Danke schön."
      },
      {
    ...
    "texts": [
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir beginnen unseren Sinkflug nach {destinationCityName}. Bitte stellen Sie sicher, dass Ihr Sicherheitsgurt angelegt ist und sich Ihre Rückenlehne und Ihr Tabletttisch in einer aufrechten Position befinden. Wir holen alle verbleibenden Serviceartikel in wenigen Minuten ab. Danke schön."
      },
      {
        ...
        "ge": "Sehr geehrte Damen und Herren, wir beginnen unseren Sinkflug. Bitte stellen Sie sicher, dass Ihr Sicherheitsgurt angelegt ist und sich Ihre Rückenlehne und Ihr Tabletttisch in einer aufrechten Position befinden. Wir holen alle verbleibenden Serviceartikel in wenigen Minuten ab. Danke schön."
      }
    ]
  },
    ...
    "texts": [
      {
        ...
        "ge": "Die Türen werden in Kürze geöffnet. Bitte denken Sie daran, alle Ihre persönlichen Gegenstände mitzunehmen. Stellen Sie sicher, dass Sie alles dabei haben, was Sie an Bord mitgebracht haben. Danke schön."
      },
      {
        ...
        "ge": "Wir sind am Gate angekommen. Bitte denken Sie daran, alle Ihre persönlichen Gegenstände mitzunehmen. Ich wünsche ihnen einen wunderbaren Tag."
      }
    ]
  }
]
